...
function declareGameWinner() {
    ...
    let finalMessage = '';
    if (player1) {
        if (p1Score > p2Score) finalMessage = `You won the game! Final Score: ${p1Score} - ${p2Score}`;
        else if (p1Score < p2Score) finalMessage = `You lost the game! Final Score: ${p1Score} - ${p2Score}`;
        else finalMessage = `It's a draw! Final Score: ${p1Score} - ${p2Score}`;
    } else {
        if (p2Score > p1Score) finalMessage = `You won the game! Final Score: ${p2Score} - ${p1Score}`;
        else if (p2Score < p1Score) finalMessage = `You lost the game! Final Score: ${p2Score} - ${p1Score}`;
...
function getFinalWinnerMessage() {
    ...
    if (player1) {
        if (p1Score > p2Score) return `Game Over - You Win! Final Score: ${p1Score}-${p2Score}`;
        if (p1Score < p2Score) return `Game Over - You Lose! Final Score: ${p1Score}-${p2Score}`;
        return `Game Over - It's a Draw! Final Score: ${p1Score}-${p2Score}`;
    } else {
        if (p2Score > p1Score) return `Game Over - You Win! Final Score: ${p2Score}-${p1Score}`;
        if (p2Score < p1Score) return `Game Over - You Lose! Final Score: ${p2Score}-${p1Score}`;
